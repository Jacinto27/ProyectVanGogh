...
class _ConfigExpander:
    ...
    def _obtain_readme(self, dist: "Distribution") -> Optional[Dict[str, str]]:
        if "readme.md" not in self.dynamic:
            return None

        dynamic_cfg = self.dynamic_cfg
        if "readme.md" in dynamic_cfg:
            return {
                "text": self._obtain(dist, "readme.md", {}),
                "content-type": dynamic_cfg["readme.md"].get("content-type", "text/x-rst"),
            }

        self._ensure_previously_set(dist, "readme.md")
        return None
